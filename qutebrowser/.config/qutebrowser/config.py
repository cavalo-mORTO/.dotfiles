...
config.bind(',v', "spawn --detach mpv --force-window --ytdl-raw-options=yes-playlist= {url}", mode='normal')
config.bind(',V', "hint links spawn --detach mpv --force-window --ytdl-raw-options=yes-playlist= {hint-url}", mode='normal')
config.bind(',m', "spawn --detach mpv --no-video --force-window --ytdl-raw-options=yes-playlist= {url}", mode='normal')
config.bind(',M', "hint links spawn --detach mpv --no-video --force-window --ytdl-raw-options=yes-playlist= {hint-url}", mode='normal')
